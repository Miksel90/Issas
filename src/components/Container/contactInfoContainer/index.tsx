...
const ContactInfoContainer = () => {
  return (
    <div className="flex flex-col items-center justify-evenly gap-10 shadow-sm shadow-black p-8 rounded h-full bg-white">
      ...
      <div className="flex flex-col gap-4 w-full">
        <p className="text-2xl font-bold text-center">Følg Oss!</p>
        <div className="flex flex-row items-center justify-center gap-15">
          <a
